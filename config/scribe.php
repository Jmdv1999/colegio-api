...
return [
    ...
    'description' => 'API del Sistema Escolar para gestión de alumnos, asignaturas, profesores y calificaciones.',
    ...
    'intro_text' => <<<'INTRO'
            ...
            <aside>Al desplazarte, verás ejemplos de código para trabajar con la API en diferentes lenguajes de programación en el área oscura a la derecha (o como parte del contenido en dispositivos móviles).
            Puedes cambiar el lenguaje usando las pestañas en la parte superior derecha (o desde el menú de navegación en la parte superior izquierda en dispositivos móviles).</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Puedes obtener tu token visitando tu panel y haciendo clic en <b>Generar token de API</b>.',
    ],
